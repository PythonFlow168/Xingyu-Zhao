...
if __name__ == "__main__":
    ...
    # Cross-validation of training set and test set of 2 rounds：
    # Epoch 1/2
    # 4/4 [==============================] - 25s 5s/step - loss: 0.5107 - val_loss: 0.2052
    # Epoch 2/2
    # 4/4 [==============================] - 17s 4s/step - loss: 0.2849 - val_loss: 0.1835

    # Error cross-validation of 3 rounds：
    # Epoch 1/3
    ...
    # After testing various manual rounds, the most balanced ones are as follows：
    # The best result: 4/4 [==============================] - 16s 4s/step - loss: 0.1487 - val_loss: 0.1145
    # Epoch 22/100
